sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("shelfmaster/ui/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("shelfmaster.ui.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["shelfmaster/ui/localService/mockserver"], function (mockserver) {
