sap.ui.define([
		...
		opaTest("MasterList Filtering on Width less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("Width").
				and.iSelectListItemInViewSettingsDialog("<100 Dimensions_unit").
		...
		opaTest("MasterList Filtering on Width more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 Dimensions_unit").
				and.iPressOKInViewSelectionDialog();
